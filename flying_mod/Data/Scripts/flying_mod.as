...
string gliding = "grab";
string flyingToggleKey = "jump + jump";
...
void FlyingAnimations() {
	if (!jump_info.hit_wall) {
		...
		if (flyingMode == 1 && air_dash < 1) {
			this_mo.SetAnimation("Data/Mods/flying_mod/Data/Animations/wingflap.anm", 5.0f, 0);
			//this_mo.SetCharAnimation("jump",20.0f,0);
			}
		//Gliding
		else if (flyingMode == 2 && air_dash < 1) {
			if(this_mo.velocity.y < -24.0f) this_mo.SetAnimation("Data/Mods/flying_mod/Data/Animations/diving.anm", 5.0f, 0);
			else this_mo.SetAnimation("Data/Mods/flying_mod/Data/Animations/glide.anm", 5.0f, 0);
			}
...
void SpinSpark()
{
	vec3 com = this_mo.GetCenterOfMass();
		...
		spin_vel += displ * -1.3f;
		MakeParticle("Data/Mods/flying_mod/Data/Particles/sparkle2.xml", head_pos, spin_vel);
